...
| Campo | Valor |
|---|---|
| Supuesto central || Algunos residentes no mantienen de manera constante las prácticas establecidas en la normativa  para la correcta disposición de los residuos. |Si implementamos mecanismos de seguimiento y recordatorios sobre las prácticas establecidas en la normativa para la disposición de residuos, entonces los residentes mantendrán de manera constante dichas prácticas.|
